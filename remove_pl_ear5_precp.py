...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 10 17:12:00 2024
...
# VARS = [['mean_snowfall_rate','msr']]

VARS = [['mean_total_precipitation_rate','mtpr']]
            ...
            for j in range(0,npl_time.shape[0],1):
                if npl_time.time[j] == str(time):
                    ...
                    if npl_x+grid_xlength >= (era5_lon.shape) or npl_x-grid_xlength < 0:
                        ...
                        median_value=np.percentile(midpara[npl_y-grid_ylength:npl_y+grid_ylength,shifted_x-grid_xlength:shifted_x+grid_xlength],70)             
                        ...
                        median_value=np.percentile(midpara[npl_y-grid_ylength:npl_y+grid_ylength,npl_x-grid_xlength:npl_x+grid_xlength],70)
            ...
            for j in range(0,spl_time.shape[0],1):
                ...
                if spl_time.time[j] == str(time):
                    ...
                    if spl_x+grid_xlength >= (era5_lon.shape) or spl_x-grid_xlength < 0:
                        ...
                        median_value=np.percentile(midpara[spl_y-grid_ylength:spl_y+grid_ylength,shifted_x-grid_xlength:shifted_x+grid_xlength],70)
                       ...
                       # midpara[spl_y-grid_length:spl_y+grid_length,shifted_x-grid_length:shifted_x+grid_length] = np.nan
                        ...
                        median_value=np.percentile(midpara[spl_y-grid_ylength:spl_y+grid_ylength,spl_x-grid_xlength:spl_x+grid_xlength],70)
